...
public class paymentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = newPayment.insertPayment(request.getParameter("NameOnCard"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = newPayment.updatePayment(paras.get("hidItemIDSave").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = newPayment.deletePayment(paras.get("p_id").toString()); 
